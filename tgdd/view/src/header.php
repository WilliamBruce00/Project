...
<div class="header">
    ...
    <div class="header__search">
        ...
        <p>
            <!-- <a href="../index.php?page=cart"><i class="fa-solid fa-cart-shopping"></i> GIỎ HÀNG</a> -->
        </p>
    </div>
</div>
<script>
    $(document).ready(() =>{
        if(localStorage.getItem("user") === null){
            ...
            $(".header__search p:eq(1)").html(
                '<a href="../index.php?page=login"><i class="fa-solid fa-cart-shopping"></i> GIỎ HÀNG</a>'
            )
        }else{
            $(".header__content--user p").html(
