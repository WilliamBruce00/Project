<?php include("./controller/update_product.php") ?>
<div class="update-product">
    <div class="close">
        <h3>Thêm sản phẩm</h3>
        <i class="fa-solid fa-xmark"></i>
    </div>
    <form action="" id="formUpdateProduct" method="post" enctype="multipart/form-data">
        ...
        <img src="" width="115px" height="169px"><br>
        ...
        <button name="submitUpdateProduct" type="submit">UPDATE</button>
    </form>
</div>